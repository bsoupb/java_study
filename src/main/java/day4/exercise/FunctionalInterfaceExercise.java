...
public class FunctionalInterfaceExercise {
    ...
    public void exercise1() {
        // 정수를 받아 짝수인지 판별하는 Predicate를 구현
    ...
    // 4. Supplier
    // 현재시간을 문자열로 반환하는 Supplier 만들기
    public void exercise4() {
        Supplier<String> getCurrentTime =
                () -> LocalDateTime.now().format(DateTimeFormatter.ofPattern("HH:mm:ss"));

        System.out.println("현재 시간: " + getCurrentTime.get());   // get(): 값을 가져옴
    }
    ...
    public void exercise7() {
        ...
        System.out.println("공백 제거: " + transformer.transform(text));
    ...
    public void exercise9() {
        ...
        // 테스트
        int number = 5;
        System.out.println("addTwoThenSquare: " + addTwoThenSquare);
        System.out.println("squareThenAddTwo: " + squareThenAddTwo);
    }
